...
export const COMMITTEE_DATA: CommitteeDetail[] = [
    ...
    },
    {
        id: slugify("Anime"),
        name: "Anime",
        tagline: "Curses shattered by clauses",
        topic: "Deliberation on the Eradication of Non-Sorcerers and the Emergence of Sorcerer Supremacy as Propagated by Suguru Geto’s Ideology.",
        iconUrl: '/images/ANIME.png',
        category: 'Media',
        about: "The Anime Committee serves as a distinctive forum within Model United Nations, where diplomacy meets creative narratives. It provides delegates with an innovative platform to engage in constructive dialogue, explore diverse perspectives, and develop collaborative solutions within a unique cultural context.",
        agendaPoints: ["Analyzing the ideological basis and narrative of sorcerer supremacy within Jujutsu society.", "Debating the ethical legitimacy and human rights concerns of eradicating non-sorcerers.", "Evaluating the political, social, and security ramifications of implementing Geto’s vision.", "Exploring sustainable alternatives to extremism, emphasizing coexistence and inclusive reform."],
