...
export const COMMITTEE_DATA: CommitteeDetail[] = [
    {
        ...
        resources: [{ title: 'UN Charter', url: 'https://www.un.org/en/about-us/un-charter', description: ''}],
        members: []
    },
    {
    ...
    },
    {
        ...
        resources: [{ title: 'The Constitution of India', url: 'https://www.india.gov.in/my-government/constitution-india', description: ''}],
        members: []
    },
    {
        ...
        resources: [{ title: 'Constituent Assembly Debates on UCC', url: 'https://www.constitutionofindia.net/constitution_assembly_debates', description: ''}],
        members: []
    },
    {
        ...
        resources: [{ title: 'Crisis Case Studies', url: 'https://www.prio.org/research/topics/conflict-trends', description: ''}],
        members: []
    },
    {
        ...
        resources: [{ title: 'ICJ Statute', url: 'https://www.icj-cij.org/statute', description: ''}],
        members: []
    },
    {
        ...
        resources: [{ title: 'BCCI', url: 'https://www.bcci.tv', description: ''}],
        members: []
    },
    
    {
        ...
        resources: [{ title: 'Player Auction Rules', url: 'https://www.iplt20.com/auction', description: ''}, { title: 'Previous Auction Data', url: 'https://www.cricbuzz.com/cricket-series/ipl-2024/auction', description: ''}],
        members: []
    },
    
    {
        ...
        resources: [{ title: 'FIFA Governance Regulations', url: 'https://digitalhub.fifa.com/m/1a78e72e52643a47/original/FIFA-Governance-Regulations-2023-edition.pdf', description: ''}],
        members: []
    },
